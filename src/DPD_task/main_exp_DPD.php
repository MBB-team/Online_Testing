...
<html>
  <head>
    ...
    <script src="jspsych-6.1.0/plugins_CC/jspsych-instructions.js"></script>
...
// --------------------------------- PARAMETERS --------------------------------//
  ...
  var nbInstr           = 11; // how many Instr Slides
  var nbScreens         = 6;
  ...
  // --------------------------------- INITIALISATION  ---------------------------//
      switch(window.location.protocol) {
            ...
            case 'https:':
                  ...
                  dataSaver = new DataSaver(dataSaverModes.SERVER, 'write_data_DPD.php');
...
// --------------------------- TEST TRIALS - PLUGINS  ------------------------//
    ...
    var fixation = {
      ...
      var test_decision = {
        ...
        if( trial_index_dec == 21 || trial_index_dec == 39 || trial_index_pred2 == 57 || trial_index_pred2 == 75 || trial_index_pred2 == 93)
        {counter_dec_phase += 1;}
      ...
      var test_prediction_0 = {
        ...
        data.decision_phase = 999;
        data.correct = (data.response+1 == data.correct_Dummy1)?1:0;
       }
     }
      ...
      var test_prediction_2 = {
        ...
        data.decision_phase = 999;
        data.correct = (data.response+1 == data.correct_Dummy2)?1:0;
       }
     }
      ...
      var test_prediction_3 = {
        ...
        data.decision_phase = 999;
        data.correct = (data.response+1 == data.correct_Dummy3)?1:0;
       }
     }
     ...
     //    data.decision_phase = 999;
     //    data.correct = (data.response+1 == data.correct_Dummy4)?1:0;
     //   }
     // }
    ...
    //     data.decision_phase = 999;
    //     data.correct = (data.response+1 == data.correct_ecosystem)?1:0;
    //    }
    // }
...
// ---------------------- CONFIDENCE TRIALS + FEEDBACK -----------------------//
    var if_confidence_pred1= {
        ...
        conditional_function: function(){
          if( trial_index_pred1 == 4 || trial_index_pred1 == 8 || trial_index_pred1 == 12 || trial_index_pred1 == 16 ) { //Confidence ratings every 4 trials
                return true;
            } else {
                return false;
            }
    ...
    var if_confidence_pred2= {
        timeline: [confidence_slider],
        conditional_function: function(){
          if( trial_index_pred2 == 4 || trial_index_pred2 == 8 || trial_index_pred2 == 12 || trial_index_pred2 == 16 ) { //Confidence ratings every 4 trials
                return true;
            } else {
                return false;
            }
    ...
    var if_confidence_pred3= {
        timeline: [confidence_slider],
        conditional_function: function(){
          if( trial_index_pred3 == 4 || trial_index_pred3 == 8 || trial_index_pred3 == 12 || trial_index_pred3 == 16 ) { //Confidence ratings every 4 trials
                return true;
            } else {
                return false;
            }
    ...
    var if_confidence_pred4= {
        timeline: [confidence_slider],
        conditional_function: function(){
          if( trial_index_pred4 == 4 || trial_index_pred4 == 8 || trial_index_pred4 == 12 || trial_index_pred4 == 16 ) { //Confidence ratings every 4 trials
                return true;
            } else {
                return false;
            }
    ...
    var if_explicit_question_pred1= {
        ...
        conditional_function: function(){
          if( trial_index_pred1 == 18) { //Explicit question at the end of each prediction phase
              return true;
          } else {
              return false;
          }
    ...
    var if_explicit_question_pred2= {
        timeline: [explicit_question],
        conditional_function: function(){
          if( trial_index_pred2 == 18) { //Explicit question at the end of each prediction phase
              return true;
          } else {
              return false;
          }
    ...
    var if_explicit_question_pred3= {
        timeline: [explicit_question],
        conditional_function: function(){
          if( trial_index_pred3 == 18) { //Explicit question at the end of each prediction phase
              return true;
          } else {
              return false;
          }
...
var test_procedure_training_pred = {
  ...
  var test_procedure_prediction_1 = {
    ...
    var prediction_phase = [test_procedure_prediction_1, test_procedure_prediction_2, test_procedure_prediction_3];
     ...
     timeline.push(test_procedure_decision); //Decision 1 (1/7 total phases)
     timeline.push(prediction_screen);
     timeline.push(shuffled_prediction_phase[0]); //Prediction 1 (2/7 total phases)
     timeline.push(decision_screen);
     timeline.push(test_procedure_decision); //Decision 2 (3/7 total phases)
     timeline.push(prediction_screen);
     timeline.push(shuffled_prediction_phase[1]); //Prediction 2 (4/7 total phases)
     timeline.push(decision_screen);
     timeline.push(test_procedure_decision); //Decision 3 (5/7 total phases)
     timeline.push(prediction_screen);
     timeline.push(shuffled_prediction_phase[2]); //Prediction 3 (6/7 total phases)
     timeline.push(decision_screen);
     timeline.push(test_procedure_decision); //Decision 4 (7/7 total phases)
     // timeline.push(prediction_screen);
