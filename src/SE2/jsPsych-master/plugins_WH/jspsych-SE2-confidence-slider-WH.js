...
jsPsych.plugins["SE2-confidence-slider-WH"] = (function() {

  var plugin = {};

  plugin.info = {
    name: "SE2-confidence-slider-WH",
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function endTrial (){
      ...
      var trial_data = {
        ...
        "SE_max":           sliderLimits[1],   // integer
        "SE_min":           sliderLimits[0],   // integer
        "SE_max_ini":       trial.start[1],   // integer
        "SE_min_ini":       trial.start[0],   // integer
