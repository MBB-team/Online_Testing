...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var cssstr = ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; }"+
      ...
      ".jspsych-survey-multi-choice-option { line-height: 1.5; text-align: left; }"+
      ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {text-align: center; display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}"+
    ...
    for (var i = 0; i < trial.questions.length; i++) {
        ...
        // add question text
        display_element.querySelector(question_selector).innerHTML += '<p class="' + plugin_id_name + '-text survey-multi-choice" style = "text-align: left;">' + trial.questions[i].prompt + '</p>';
    ...
    trial_form.addEventListener('submit', function(event) {
      ...
      var trial_data = {
        "rt": response_time,
        "stimulus": JSON.stringify(question_data),
        "stimulus2": "null",
        "position": 777,
        "key_press": 777,
        "response": 777,
