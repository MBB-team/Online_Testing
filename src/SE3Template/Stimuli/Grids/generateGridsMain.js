...
* Updated: 23/11/2022
*  generateGridsMain(numbersImg, gridIndexesTrain, exp.squareSize, matchingPairs, [0], exp.grid);
*/

function generateGridsMain(numbersImg, gridIndexesPt, TSPt){
  ...
  for (var grid_i = 0; grid_i <= nbTrials-1; grid_i++){ // for each grid
    ...
    console.log("the grid_i is:", grid_i);
    console.log("the Target score array for this part is", TSPt)
    console.log("so for this trial its:", TSPt[grid_i]);
