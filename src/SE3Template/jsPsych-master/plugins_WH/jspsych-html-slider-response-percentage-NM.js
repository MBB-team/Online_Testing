...
jsPsych.plugins['html-slider-response-percentage-NM'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        */
        ...
        html += '<span style="font-size: 100%;">0%</span>';
        html += '</div>';
        ...
        html += 'Vous avez choisi <output>'+trial.start+'</output> %';
      
        html += '</div>';
       
        html += '<div style="text-align: center; margin-left: 1em;">';
        html += '<span style="font-size: 100%;">100%</span>';
