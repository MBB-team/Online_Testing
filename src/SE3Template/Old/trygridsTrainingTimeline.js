      ...
      on_start: function(feedback){
        ...
        if (nCorrect_train >= TS_current){
          points_total_train = points_total_train + rew_current;
            ...
            feedback.stimulus = '<p style="margin:0px">Vous avez correctement retrouvé <b>'+nCorrect_train+'</b>' + emplacements + '!</p><p>Vous avez réussi l\'exercice. Vous gagnez ' +train_rew + ' point.</p>';
