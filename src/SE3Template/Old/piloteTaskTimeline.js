...
// ==== ÉTAPE 4 - QUESTIONS AUTO-ÉVALUATION ====
    ...
    var finish = {
      ...
      stimulus: function(){
        ...
        var finish_stim = '<p>Le test de me&#769moire est maintenant termine&#769.</p><p>En total, vous avez réussi : <b>'+pointsTotal+' '+points_fin+'</b> sur 16.</p><p><b>Merci beaucoup pour votre participation !</b></p>';
        return finish_stim;
      },
      choices: ['Fin'],
      data: {
