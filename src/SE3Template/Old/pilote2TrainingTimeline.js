function trygridsTrainingTimeline(){
    ...
    var squareSize          = exp.squareSize;
    console.log("The current grid is:", gridStimuliTrain)
 ...
 var instructions15 = {
  ...
  timelineTask_train.push(instructions15);
      ...
      on_start: function(feedback){
        ...
        if (nCorrect_train >= TS_current){
          points_total_train = points_total_train + rew_current;
            ...
            feedback.stimulus = '<p style="margin:0px">Vous avez correctement retrouvé <b>'+nCorrect_train+'</b>' + emplacements + '!</p><p>Vous avez réussi l\'exercice. Vous gagnez <b>' +train_rew + '</b> point.</p>';
        
        } else {
          feedback.stimulus = '<p style="margin:0px">Vous avez correctement retrouvé <b>'+nCorrect_train+'</b>' + emplacements + '!</p><p>Vous n\'avez pas réussi l\'exercice. Vous ne gagnez aucun point.</p>';
        }
      },
      on_finish: function(data){
    ...
    timelineTask_train.push(instructions18);
      ...
      var challenge_train = {
        type: 'html-button-response-WH',
        stimulus: '<p>Préférez vous:  ?</p> <p> <b>Choix A:</b> Mémoriser <b>4 paires</b> pour tenter de gagner <b> 1 point </b></p> <p> <b> Choix B: </b>Mémoriser <b>8 paires</b> pour tenter de gagner <b> 10 points </b></p>',
      ...
      timelineTask_train.push(fullscreenExp);
      timelineTask_train.push(challenge_train);
