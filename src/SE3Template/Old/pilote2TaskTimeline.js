function tryGridsTaskTimeline(){
    ...
    for (var trialInd = 0; trialInd < exp.nbTrials; trialInd++){
      ...
      let test_counter   = 0;
      console.log("The current grid is:", gridStimuliCurrent)
      ...
      console.log ("CORRTEST: at START of the", trialInd, "loop, the n_correct is", nCorrect, "and the correct matrix is", correct_i)
      var effort_want = {
        type: 'html-slider-response-effort-want-WH',
        prompt: '<p> Exercice : '+trialNbCurrent+'/'+exp.nbTrials+'.<p style="font-size:30px">Votre objectif est de mémoriser <b>'+TSCurrent+' paires de chiffres</b>.</p><p style="font-size:30px">Si vous atteignez cet objectif, vous gagnerez <b>'+rewCurrent+'</b> points. </p><div><br></div>',
...
// ==== ÉTAPE 4 - QUESTIONS AUTO-ÉVALUATION ====
      ...
      //console.log ("the current correct_i array is", correct_i)
      //console.log("the current correct counter is", nCorrect)
      var feedback_sans_grid = {
        ...
        on_start: function(feedback){
          ...
          if (nCorrect >= TSCurrent){
            pointsTotal++;
            rewTotal = rewTotal+rewCurrent;
            nTS++;
            feedback.stimulus = '<p style="margin:0px">Vous avez correctement retrouvé <b>'+nCorrect+'</b>' + emplacementsStr + '!</p><p> Bravo, vous avez réussi cet exercice. Vous gagnez <b>' + rewCurrent+ '</b> points. </p>';
          } else {
            feedback.stimulus = '<p style="margin:0px">Vous avez correctement retrouvé <b>'+nCorrect+'</b>' + emplacementsStr + '!</p><p> Malheureusement, vous n\'avez pas réussi cet exercice. Vous ne gagnez aucun point. </p>';
          };
        },
      ...
      console.log ("CORRTEST: at END of the", trialInd, "loop, the n_correct is", nCorrect, "and the correct matrix is", correct_i)
    ...
    var finish = {
      ...
      stimulus: function(){
        ...
        var points_fin = pointsTotal == 1 ? 'exercice':'exercices';
        var finish_stim = '<p>Le test de me&#769moire est maintenant termine&#769.</p><p>En total, vous avez réussi : <b>'+pointsTotal+' '+points_fin+'</b> sur 16. Vous gagnez un total de <b>' +rewTotal+'points.</p><p><b>Merci beaucoup pour votre participation !</b></p>';
        return finish_stim;
      },
      choices: ['Fin'],
      data: {
