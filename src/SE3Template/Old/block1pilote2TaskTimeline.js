function block1pilote2TaskTimeline(){
...
// ==== ÉTAPE 4 - QUESTIONS AUTO-ÉVALUATION ====
      ...
      var nextexo = {
        type: 'html-button-response-WH',
        stimulus:'<p> Vous avez fini exercice '+trialNbCurrent+'/'+exp.nbTrials+'. </p> <p> Quand vous êtes prêt.e.s: </p>',
        choices: ['Passer au prochain exercise'],
        data: {
            test_part: 'next_exo',
            get_data: 0,
            blockInd: 1,
