...
<html>
      <head>
            ...
            <script   src  = 'tryGridsTaskTimeline.js'></script>     <!-- NEED TO CHANGE -->
...
<script type="application/javascript">
  ...
  if (browserInfo.browser !== 'Chrome' && browserInfo.browser !== 'Firefox') {
    ...
    var rewPt      =rewArray[PartID][sessID][blockID];
    ...
    function startExperiment(){
      ...
      jsPsych.init({
       ...
       on_finish: function (data) {
        ...
        var filename = "trygrids_part" + PartID + "_sess" + sessID + "_block" + blockID + "_data.csv";
