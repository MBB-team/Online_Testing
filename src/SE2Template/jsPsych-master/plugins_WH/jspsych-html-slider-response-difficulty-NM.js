...
jsPsych.plugins['html-slider-response-difficulty-NM'] = (function() {

    var plugin = {};
  
    plugin.info = {
      name: 'html-slider-response-percentage-NM',
      description: '',
      parameters: {
        stimulus: {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        html += '<div class="jspsych-html-slider-response-container" style="display: flex; align-items: center; justify-content: center; position: relative; margin: 0 auto 1em auto; ';
        if(trial.slider_width !== null){
          html += 'width:'+my_width+'px;';
        }
        html += '">';
        html += '<div style="text-align: center; margin-right: 1em;">';
        html += '<span style="font-size: 100%;">Très faisable</span>';
        html += '</div>';
        html += '<div style="flex: 1; position: relative;width: 300px">';
        html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 100%;" id="jspsych-html-slider-response-response" oninput="this.nextElementSibling.value = this.value">';
        html += '</div>';
        html += '<div style="text-align: center; margin-left: 1em;">';
        html += '<span style="font-size: 100%;">Trop difficile</span>';
        html += '</div>';
        html += '</div>';
        html += '</div>';
