...
--
-- Table structure for table `tableSE3`
--

CREATE TABLE IF NOT EXISTS `tableSE3` (
  ...
  `blockInd` int(3) DEFAULT NULL,
  `SE_type` text DEFAULT NULL,
  `SE_eff` FLOAT DEFAULT NULL,
  ...
  `reward` int(4) DEFAULT NULL,
  `finalNC` int(3) DEFAULT NULL,
